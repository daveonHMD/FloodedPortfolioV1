                ...
                <div className="flex justify-center items-center h-96 before:h-[300px] before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 after:dark:via-[#be3434]/40 before:lg:h-[360px]">
                    ...
                    <div className="ml-8">
                        <h1 className="text-3xl font-bold">
                            {`Hi, I'm ${username}`}{" "}
                            <span className="badge mx-1 hidden md:inline-block">
                                Not Hireable
                            </span>
                        </h1>
                        <p className="text-xl">{bio}</p>
                        <p className="text-gray-600">
                            Started coding in 2020/2021
                        </p>
                    </div>
                </div>
                <div className="mt-12">
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <LibraryCard
                            title="React"
                            javascript
                            description="React = Components build apps. Dynamic UX."
                            imageUrl="/imgs/webbanner/react.logo-og.png"
                        />
                        <LibraryCard
                            title="Express.js"
                            javascript
                            description="Fast, unopinionated, minimalist web framework for Node.js"
                            imageUrl="/imgs/webbanner/express.logo-com.png"
                        />
                        <LibraryCard
                            title="Flask"
                            python
                            description="Flask is a web application framework written in Python."
                            imageUrl="/imgs/webbanner/flask.logo-og.png"
                        />
                        <LibraryCard
                            title="Next.js"
                            javascript
                            description="Next.js Empowering World's Giants with Full-Stack Web Apps & Lightning-Fast Builds!"
                            imageUrl="/imgs/webbanner/nextjs.logo-org.png"
                        />
                    </div>
                </div>
                <div className="mt-12">
    ...
    return (
        <div className="bg-secondary rounded-lg shadow-md p-4 hover:shadow-lg hover:-translate-y-1 hover:scale-105 transition-transform">
            ...
            <h3 className="text-lg font-semibold mb-2 mt-2">
                {title}
                {javascript ? (
                    <span className="mx-1 rounded-md badge badge-flat-warning badge-square">
                        JavaScript
                    </span>
                ) : null}
                {python ? (
                    <span className="mx-1 rounded-md badge badge-flat-primary badge-square">
                        Python
                    </span>
                ) : null}
            </h3>
