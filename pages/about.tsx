    ...
    <Link href={project.url}>
      <span className="drop-shadow-xl block bg-secondary rounded-lg shadow-md p-4 hover:shadow-lg hover:-translate-y-1 hover:scale-105 transition-transform">
        ...
        <h3 className="text-lg font-semibold mb-2">
          {project.title}{' '}
          {project.disabled && (<span className="mx-1 rounded-md badge badge-square">DISABLED</span>)}
          {project.beta && (<span className="mx-1 rounded-md badge badge-square">BETA</span>)}
        </h3>
